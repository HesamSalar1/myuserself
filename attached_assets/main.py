...
app = Client("bot1_session", api_id, api_hash)
...
async def backup_database(client, message: Message):
    try:
        ...
        shutil.copy2('bot1_database.db', backup_name)
...
async def test_command(client, message: Message):
    ...
    try:
        stats = get_stats()
        import os
        db_size = os.path.getsize('bot1_database.db') / 1024  # KB
...
async def run_self(client, message: Message):
    ...
    try:
        ...
        db_size = os.path.getsize('bot1_database.db') / 1024
