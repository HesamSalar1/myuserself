...
async def auto_reply_handler(client, message: Message):
    ...
    # بررسی دشمن بودن - بات 4 با تاخیر 0.003 ثانیه
    ...
    # بررسی دوست بودن - بات 4 با تاخیر 0.003 ثانیه
...
async def bot_ready():
    ...
    logger.info("ربات 4 آماده شد و کش راه‌اندازی شد!")

print("Bot 4 initialized and ready!")
logger.info("ربات 4 آماده شد!")
