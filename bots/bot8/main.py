...
async def auto_reply_handler(client, message: Message):
    ...
    if user_id in enemy_cache and fosh_cache:
        ...
        asyncio.create_task(send_delayed_reply(message, selected, 0.006))
        return

    # بررسی دوست بودن - بات 8 با تاخیر 0.006 ثانیه
...
async def bot_ready():
    ...
    logger.info("ربات 8 آماده شد و کش راه‌اندازی شد!")

print("Bot 8 initialized and ready!")
logger.info("ربات 8 آماده شد!")
